...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">  
            Pagina principal<br>
            <a href="Pagina_Secundaria.php">Ir a la pagina secundaria</a><br>
            <a href="Contacto.php">Ir a la pagina de contacto</a><br>    
            <a href="carousel.php">Ir a la pagina de carrusel</a><br>

            <div id="seccionProductos" class="d-none">
